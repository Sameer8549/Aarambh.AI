...
export const wellnessResources: Resource[] = [
    ...
    // === Articles & Information (Reputable Global Organizations) ===
    {
      ...
      keywords: ['article', 'information', 'who', 'global health', 'mental health', 'depression', 'treatment', 'medicine', 'anxiety', 'stress'],
    },
    {
      ...
      type: ResourceTypeEnum.Article,
      keywords: ['article', 'information', 'nimh', 'mental disorders', 'anxiety', 'depression', 'stress', 'treatment', 'medicine', 'feeling low'],
    },
    {
        ...
        type: ResourceTypeEnum.Article,
        keywords: ['article', 'information', 'mind uk', 'mental health', 'support', 'well-being', 'treatment', 'medicine', 'anxiety', 'depression'],
    },
    {
