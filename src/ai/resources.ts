...
export const wellnessResources: Resource[] = [
    ...
    },
    {
        ...
        link: 'Tara Brach Guided Meditations',
        type: ResourceTypeEnum.Video,
    ...
    },
    {
    ...
    },
     {
        ...
        link: 'The Honest Guys guided imagery meditation',
        type: ResourceTypeEnum.Video,
    ...
    },
    {
        ...
        type: ResourceTypeEnum.Video,
        keywords: ['meditation', 'self-love', 'acceptance', 'short', 'guided'],
    },
    ...
    },
    {
    ...
    },
     {
      ...
      type: ResourceTypeEnum.Exercise,
      keywords: ['exercise', 'anxiety', 'grounding', '5 senses', 'mindfulness', 'article'],
    },
    {
      ...
      link: '10 minute fun dance workout',
      type: ResourceTypeEnum.Exercise,
      keywords: ['exercise', 'dance', 'workout', 'fun', 'energy', 'video'],
    },
    ...
    },
    {
      ...
      type: ResourceTypeEnum.Podcast,
      keywords: ['podcast', 'anxiety', 'confidence', 'calm', 'self-help'],
    },
    ...
    },
    {
      ...
      type: ResourceTypeEnum.Article,
      keywords: ['article', 'mindfulness', 'beginners', 'verywell mind', 'stress'],
    },
