    ...
    >
      <defs>
        <radialGradient
          ...
          fy="50%"
        >
          <stop offset="0%" stopColor="#43D4A8" stopOpacity="0.8" />
          <stop offset="50%" stopColor="#855CF8" stopOpacity="0.7" />
          <stop offset="100%" stopColor="#43D4A8" stopOpacity="0.3" />
        </radialGradient>
        <linearGradient id="path-gradient-blue-purple" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#855CF8" />
          <stop offset="100%" stopColor="#43D4A8" />
        </linearGradient>
